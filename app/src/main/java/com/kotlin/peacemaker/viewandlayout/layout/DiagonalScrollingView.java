 ...
 */
public class DiagonalScrollingView extends FrameLayout {
    ...
    public DiagonalScrollingView(Context context) {
        super(context);
        initTwoDScrollView();
    }

    public DiagonalScrollingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initTwoDScrollView();
    }

    public DiagonalScrollingView(Context context, AttributeSet attrs, int defStyle) {
